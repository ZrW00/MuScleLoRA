...
class BKIDefender(Defender):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.trainer = Trainer(
            warm_up_epochs=warm_up_epochs, epochs=epochs, 
            batch_size=batch_size, lr=lr,
            save_path='./models/bki', 
            ckpt='last', 
    ...
    def analyze_data(self, model:Victim, poison_train):
        for sentence, target_label, _ in tqdm(poison_train, total=len(poison_train), desc="purifying training dataset"):
